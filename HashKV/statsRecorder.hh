...
private:
    ...
    struct hdr_histogram *_setTimeHistogram;
    struct hdr_histogram *_updateTimeHistogram;
    struct hdr_histogram *_getTimeHistogram;
    struct hdr_histogram *_scanTimeHistogram;
    struct hdr_histogram *_deleteTimeHistogram;


    std::map<unsigned long long, struct hdr_histogram*> _setByValueSizeHistogram;
    ...
    std::map<unsigned long long, struct hdr_histogram*> _scanByLenSizeHistogram;
